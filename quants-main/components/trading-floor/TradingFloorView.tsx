                            ...
                            <div key={`${room.id}-${offer.token}`} className={styles.offerCard}>
                                <div className={styles.offerHeader}>
                                    ...
                                    <span className={styles.offerPrice}>
                                        ...
                                        {/* FIX: Correctly access price based on the 'Offer' discriminated union type. */}
                                        {offer.type === 'intel' ? offer.price.toLocaleString() : (offer.price_per_token * offer.quantity).toLocaleString()} BOX
                                    </span>
                                </div>
                                {seller && (
