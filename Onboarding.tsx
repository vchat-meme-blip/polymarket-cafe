...
// FIX: The 'Agent' type was being imported from 'presets' which does not export it. Split the import to get the 'Agent' type from its correct source 'lib/types/index.js' and values from 'lib/presets/agents'.
...
import { VrmAvatarCanvas, VrmModel } from './components/agents/VrmAvatar';
  ...
  return (
    <div className={styles.onboardingContainer}>
      <div className={styles.onboardingCard}>
        ...
        {/* FIX: Moved wave effect outside the form to position correctly at the bottom of the card */}
