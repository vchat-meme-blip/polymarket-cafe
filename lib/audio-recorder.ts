...
export class AudioRecorder {
  ...
  public on(event: string | symbol, fn: (...args: any[]) => void): this {
    this.emitter.on(event, fn);
    return this;
  }

  public off(event: string | symbol, fn: (...args: any[]) => void): this {
  ...
  async start() {
    ...
    this.starting = new Promise(async (resolve, reject) => {
      ...
      // Create AudioContext without specifying a sampleRate to avoid mismatch errors.
      // It will use the device's native sample rate.
