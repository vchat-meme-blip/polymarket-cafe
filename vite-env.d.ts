// This file manually defines Vite's environment types to resolve issues
// where the default `vite/client` types are not being picked up by TypeScript.
// This ensures properties like `import.meta.env.PROD` are correctly typed.
